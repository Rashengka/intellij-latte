...
public class LattePhpTypeDetector {
    /**
     * A member's type is read through a new walk, so {@code {var $a = $a->child}} comes back here
     * for the same element with an empty {@code visiting} set. A cycle answers mixed.
     */
